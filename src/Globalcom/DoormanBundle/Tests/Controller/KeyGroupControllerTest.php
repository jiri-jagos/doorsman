...
class KeyGroupControllerTest extends WebTestCase
{
    public function testCreate()
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/KeyGroup/');
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/KeyGroup/new');
