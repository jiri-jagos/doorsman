...
class KeyControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'key[code]' => 'First value',
            'key[desc]' => 'First value',
            'key[color]' => 'First value',
            'key[number]' => 'First value',
            'key[text]' => 'First value',
            'key[createdAt]' => 'First value',
    ...
    public function testFilter()
    {
        ...
        $form = $crawler->filter('div#filter form button[type="submit"]')->form(array(
            'key_filter[code]' => 'First%',
            'key_filter[desc]' => 'First%',
            'key_filter[color]' => 'First%',
            'key_filter[number]' => 'First%',
            'key_filter[text]' => 'First%',
            'key_filter[createdAt]' => 'First%',
