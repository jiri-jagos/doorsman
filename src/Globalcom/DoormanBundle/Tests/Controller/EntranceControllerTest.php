...
namespace Globalcom\DoormanBundle\Tests\Controller;

use Symfony\Bundle\FrameworkBundle\Test\WebTestCase;

class EntranceControllerTest extends WebTestCase
{
    public function testCreate()
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/Entrance/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'entrance[ip]' => 'First value',
            'entrance[desc]' => 'First value',
            'entrance[code]' => 'First value',
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/Entrance/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'entrance[ip]' => 'Changed',
            'entrance[desc]' => 'Changed',
            'entrance[code]' => 'Changed',
            // ... adapt fields value here ...
        ));
        $client->submit($form);
        $crawler = $client->followRedirect();
    ...
    public function testFilter()
    {
        ...
        $form = $crawler->filter('div#filter form button[type="submit"]')->form(array(
            'entrance_filter[ip]' => 'First%',
            'entrance_filter[desc]' => 'First%',
            'entrance_filter[code]' => 'First%',
