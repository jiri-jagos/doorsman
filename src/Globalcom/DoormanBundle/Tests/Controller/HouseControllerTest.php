...
class HouseControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $crawler = $client->request('GET', '/admin/House/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'house[desc]' => 'First value',
            'house[town]' => 'First value',
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/House/new');
    ...
    public function testFilter()
    {
        ...
        $form = $crawler->filter('div#filter form button[type="submit"]')->form(array(
            'house_filter[desc]' => 'First%',
            'house_filter[town]' => 'First%',
